...
namespace App\Modules\Certificados\Imports;
 ...
 * encabezado (primera fila). Las reglas de negocio viven en
 * CertificadoService::emitirCapacitacionDesdeFilas(), no aquí (mismo
 * patrón que App\Modules\Evaluaciones\Imports\HojaConEncabezadosImport).
 */
